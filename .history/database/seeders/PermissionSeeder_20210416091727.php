...
class PermissionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        array_push($permissions_public,Permission::create(['name' => 'usuario_productos_listar']));
        array_push($permissions_public,Permission::create(['name' => 'usuario_productos_nuevo']));
