<x-public-layout>
    ...
    <section class="page-banner-110">
        <div class="py-5 text-center">
            ...
            <h2></h2>
            <div class="alert alert-info m-5">Gracias por registrarte! Antes de comenzar, ¿podría verificar su dirección de correo electrónico haciendo clic en el enlace que le acabamos de enviar? Si no recibió el correo electrónico, con gusto le enviaremos otro.</div>
