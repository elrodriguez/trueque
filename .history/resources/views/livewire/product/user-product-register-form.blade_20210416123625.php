<div>
                           ...
                           <form action="#">
                                ...
                                <div class="single-form form-default form-border">
                                    ...
                                    <div class="row">
                                        ...
                                        @error('descripcion_corta') <span class="error">{{ $message }}</span> @enderror
                                    </div>
                                </div>
                                <div class="single-form form-default form-border">
                                    ...
                                    <div class="row">
                                        ...
                                        @error('descripcion_larga') <span class="error">{{ $message }}</span> @enderror
                                    </div>
                                </div>
                                <div class="single-form form-default form-border ">
                                    <div class="row">
                                ...
                                <div class="single-form form-default form-border">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12  form-input">
                                            <textarea id="exampleFormControlTextarea1" rows="3" wire:model.defer="preferencias"></textarea>
                                        </div>
                                        @error('preferencias') <span class="error">{{ $message }}</span> @enderror
                                    </div>
                                </div>
                                <div class="single-form form-default form-border ">
                                    <div class="row">
                                ...
                                <div class="single-form">
                                    <button class="main-btn primary-btn" type="button" wire:click="save">ACEPTAR</button>
    ...
    <script>
        window.addEventListener('response_products_store', event => {
