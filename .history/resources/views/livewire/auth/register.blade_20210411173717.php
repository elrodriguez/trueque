                       ...
                       <div class="login-registration-form pt-10">
                           <form class="needs-validation" novalidate method="POST" action="{{ route('public_user_create') }}">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="form-input">
                                                <input type="text" placeholder="Nombres" id="name" name="name" value= required autofocus autocomplete="name">
                                ...
                                <div class="single-form form-default form-border">
                                        ...
                                        <div class="form-input">
                                            <input type="email" placeholder="usuario@email.com" id="email" name="email" required>
